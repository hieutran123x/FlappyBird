...
import { GroundMover } from './GroundMover';
import { Result } from './Result';
import { Bird } from './Bird';
import { PipePool } from './PipePool';
import { BirdAudioCtrl } from './BirdAudioCtrl';

@ccclass("GameCtrl")
export class GameCtrl extends Component {
  @property({type: Component})
  public ground: GroundMover;
  ...
  @property({type: BirdAudioCtrl})
  public clip: BirdAudioCtrl;
